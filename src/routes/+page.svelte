    ...
    <header class="w-full">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-8 text-lg">
                ...
                <div class="relative">
                    <button 
                        class="hover:text-gray-500 transition-colors fade-in-element delay-4 focus:outline-none"
                    ...
                    <!-- Connect Dropdown -->
                    {#if connectDropdownOpen}
                        <div class="absolute right-0 top-full mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50 connect-dropdown" class:closing={connectDropdownClosing}>
                            <a 
                            ...
                            >
                                <span class="text-gray-900">Instagram</span>
                            ...
                            <a 
                                ...
                                class="flex items-center justify-between px-4 py-3 hover:bg-gray-50 transition-colors"
                            >
                                <span class="text-gray-900">Substack</span>
                                <svg class="w-5 h-5 text-gray-600" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {#if connectDropdownOpen}
                        <div class="mt-2 ml-4 flex flex-col space-y-3 connect-dropdown" class:closing={connectDropdownClosing}>
                            <a 
                                ...
                                target="_blank" 
                                rel="noopener noreferrer"
                                class="flex items-center justify-between py-2 hover:text-gray-500 transition-colors"
